    ...
    <div class="container">
        ...
        <div class="row-fluid text-white">
            <div class="col-md-12">
                ...
                <p class="text-secondary">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga ex dicta aspernatur expedita delectus laborum at, quaerat odit voluptas alias eum id sapiente velit natus impedit repudiandae nobis nihil quisquam.</p>
            </div>
        </div>
